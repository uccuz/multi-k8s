...
kubectl set image deployments/client-deployment server=justin89721/multi-client:$SHA
kubectl set image deployments/worker-deployment server=justin89721/multi-worker:$SHA